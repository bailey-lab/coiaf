...
knitr::include_graphics('Sensitivity Analysis Figures/tcoi.pdf')
```
...
knitr::include_graphics('Sensitivity Analysis Figures/tcoi_range.pdf')
```
...
knitr::include_graphics('Sensitivity Analysis Figures/tmethod.pdf')
```
...
knitr::include_graphics('Sensitivity Analysis Figures/tdistance.pdf')
```
...
knitr::include_graphics('Sensitivity Analysis Figures/tweight.pdf')
```
...
knitr::include_graphics('Sensitivity Analysis Figures/tcoverage.pdf')
```
...
knitr::include_graphics('Sensitivity Analysis Figures/talpha.pdf')
```
...
knitr::include_graphics('Sensitivity Analysis Figures/tover.pdf')
```
...
knitr::include_graphics('Sensitivity Analysis Figures/tepsilon.pdf')
```
...
knitr::include_graphics('Sensitivity Analysis Figures/tseq.pdf')
```
