...
toverall <- cont_sensitivity(coi = 1:25, max_coi = 30, repetitions = 10, 
                             plaf = p, coverage = 200, seq_error = 0, 
                             coi_method = c("1", "2"))
...
tcoi <- cont_sensitivity(coi = 2:40, max_coi = 40, repetitions = 10, plaf = p,
                         coi_method = c("1", "2"))
...
bloci <- lapply(loci, function(new_L){
  ...
  inner_tloci <- cont_sensitivity(coi = 2:20, repetitions = 10, plaf = new_p,
                             coi_method = "1")
