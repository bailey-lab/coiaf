...
toverall <- cont_sensitivity(coi = 1:25, max_coi = 30, repetitions = 100, 
                             plaf = p, coverage = 400, seq_error = 0, 
                             coi_method = c("1", "2"))
...
tcoi <- cont_sensitivity(coi = 2:40, max_coi = 40, repetitions = 100, plaf = p,
...
tcomparison <- cont_sensitivity(coi = 2:20, plaf = p, 
...
tdistance <- cont_sensitivity(coi = 2:20, plaf = p, comparison = "overall",
...
tcoverage <- cont_sensitivity(coi = 2:20, coverage = c(25, 50, 100, 200, 400, 800), 
...
bloci <- lapply(loci, function(new_L){
  ...
  inner_tloci <- cont_sensitivity(coi = 2:20, repetitions = 100, plaf = new_p,
...
talpha_1 <- cont_sensitivity(coi = 2:20, alpha = seq(0.01, 5.51, 0.5), 
...
talpha_2 <- cont_sensitivity(coi = 2:20, alpha = seq(0.01, 5.51, 0.5), 
                            repetitions = 100, seq_error = 0.01, plaf = p)
...
tover <- cont_sensitivity(coi = 2:20, overdispersion = seq(0, 0.2, 0.05), 
                          repetitions = 100, seq_error = 0.01, 
                          plaf = p, coi_method = c("1", "2"))
...
trelated <- cont_sensitivity(coi = 2:20, relatedness = seq(0, 0.5, 0.1), 
                             repetitions = 100, seq_error = 0.01, 
                             plaf = p, coi_method = c("1", "2"))
...
tepsilon <- cont_sensitivity(coi = 2:20, epsilon = seq(0, 0.008, 0.001), 
                             repetitions = 100, seq_error = 0.01, plaf = p)
...
tseq <- cont_sensitivity(coi = 2:20, epsilon = 0.1, 
...
tbin <- cont_sensitivity(coi = 2:20, bin_size = seq(10, 100, 30),
...
for (i in seq_len(length(update_images))){
  filename = paste0("figures/continuous/", 
