...
knitr::include_graphics('vignettes/Sensitivity Analysis Figures/Sensitivity Plots/tcoi_image.png')
knitr::include_graphics('vignettes/Sensitivity Analysis Figures/Error Images/tcoi_error.png')
```
...
knitr::include_graphics('vignettes/Sensitivity Analysis Figures/Sensitivity Plots/tmethod_image.png')
knitr::include_graphics('vignettes/Sensitivity Analysis Figures/Error Images/tmethod_error.png')
```
...
knitr::include_graphics('vignettes/Sensitivity Analysis Figures/Sensitivity Plots/tdistance_image.png')
knitr::include_graphics('vignettes/Sensitivity Analysis Figures/Error Images/tdistance_error.png')
```
...
knitr::include_graphics('vignettes/Sensitivity Analysis Figures/Sensitivity Plots/tweight_image.png')
knitr::include_graphics('vignettes/Sensitivity Analysis Figures/Error Images/tweight_error.png')
```
...
knitr::include_graphics('vignettes/Sensitivity Analysis Figures/Sensitivity Plots/tcoverage_image.png')
knitr::include_graphics('vignettes/Sensitivity Analysis Figures/Error Images/tcoverage_error.png')
```
...
knitr::include_graphics('vignettes/Sensitivity Analysis Figures/Sensitivity Plots/tloci_image.png')
knitr::include_graphics('vignettes/Sensitivity Analysis Figures/Error Images/tloci_error.png')
```
...
knitr::include_graphics('vignettes/Sensitivity Analysis Figures/Sensitivity Plots/talpha_image.png')
knitr::include_graphics('vignettes/Sensitivity Analysis Figures/Error Images/talpha_error.png')
```
...
knitr::include_graphics('vignettes/Sensitivity Analysis Figures/Sensitivity Plots/tover_image.png')
knitr::include_graphics('vignettes/Sensitivity Analysis Figures/Error Images/tover_error.png')
```
...
knitr::include_graphics('vignettes/Sensitivity Analysis Figures/Sensitivity Plots/tepsilon_image.png')
knitr::include_graphics('vignettes/Sensitivity Analysis Figures/Error Images/tepsilon_error.png')
```
...
knitr::include_graphics('vignettes/Sensitivity Analysis Figures/Sensitivity Plots/tseq_image.png')
knitr::include_graphics('vignettes/Sensitivity Analysis Figures/Error Images/tseq_error.png')
```
...
saveRDS(saved_analysis, file = "vignettes/saved_analysis.rds")
...
for (i in seq_len(length(update_images))){
  filename = paste0("vignettes/Sensitivity Analysis Figures/Sensitivity Plots/", 
...
for (i in seq_len(length(update_errors))){
  filename = paste0("vignettes/Sensitivity Analysis Figures/Error Images/", 
