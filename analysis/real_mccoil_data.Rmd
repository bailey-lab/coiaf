...
ggplot() +
  ...
  geom_polygon(data = world, aes(x = long, y = lat, group = group), 
               fill = "grey", alpha = 0.3) +
  geom_point(data = map_average, aes(x = long, y = lat, 
                                     size = coi_med, color = coi_med)) +
  viridis::scale_color_viridis(limits = c(1, 2), breaks = c(1.0, 1.5, 2.0)) + 
  theme_void() + 
...
ggplot() +
  ...
  viridis::scale_color_viridis(limits = c(1, 10)) +
  theme_void() + 
  theme(legend.position = "bottom") +
  scale_size(guide = "none") + 
  labs(color = "COI") +
