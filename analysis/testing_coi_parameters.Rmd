...
## COI Range
```{r}
test <- coi_test(COI = 2:9, COI_range = 1:10, repetitions = 100,
                 PLAF = p, method = "overall", dist_method = "squared")
test$error_bias
```
...
## Coverage
```{r}
test <- coi_test(COI = 2:9, coverage = seq(100, 500, 100), 
                 COI_range = 10, repetitions = 100,
                 PLAF = p, method = "overall", dist_method = "squared")
test$error_bias
```
...
## Alpha
```{r}
test <- coi_test(COI = 2:9, alpha = 1:10, 
                 COI_range = 10, repetitions = 100,
                 PLAF = p, method = "overall", dist_method = "squared")
test$error_bias
```
...
## Overdispersion
```{r}
test <- coi_test(COI = 2:9, overdispersion = seq(0, 0.1, 0.05), 
                 COI_range = 10, repetitions = 100,
                 PLAF = p, method = "overall", dist_method = "squared")
test$error_bias
```
...
## Epsilon
```{r}
test <- coi_test(COI = 2:9, epsilon = seq(0, 1, 0.1), 
                 COI_range = 10, repetitions = 100,
                 PLAF = p, method = "overall", dist_method = "squared")
test$error_bias
```
...
## Sequencing Error
```{r}
test <- coi_test(COI = 2:9, seq_error = seq(0, 0.1, 0.02), 
                 COI_range = 10, repetitions = 100,
                 PLAF = p, method = "overall", dist_method = "squared")
test$error_bias
```
...
## Weighted
```{r}
test <- coi_test(COI = 2:9, weighted = c(FALSE, TRUE),
                 PLAF = p, method = "overall", repetitions = 50)
test$error_bias
```
