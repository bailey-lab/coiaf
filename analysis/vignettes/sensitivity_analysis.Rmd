...
# %>% ggpubr::ggexport(filename = "analysis/analysis/vignettes/figures/sensitivity_plots/tcoi_image.png")
# %>% ggpubr::ggexport(filename = "analysis/analysis/vignettes/figures/error_images/tcoi_error.png")
```

```{r coi image, eval = eval_images, echo = F, out.width = "75%"}
knitr::include_graphics('analysis/vignettes/figures/sensitivity_plots/tcoi_image.png')
knitr::include_graphics('analysis/vignettes/figures/error_images/tcoi_error.png')
```
...
knitr::include_graphics('analysis/vignettes/figures/sensitivity_plots/tmethod_image.png')
knitr::include_graphics('analysis/vignettes/figures/error_images/tmethod_error.png')
```
...
knitr::include_graphics('analysis/vignettes/figures/sensitivity_plots/tdistance_image.png')
knitr::include_graphics('analysis/vignettes/figures/error_images/tdistance_error.png')
```
...
knitr::include_graphics('analysis/vignettes/figures/sensitivity_plots/tweight_image.png')
knitr::include_graphics('analysis/vignettes/figures/error_images/tweight_error.png')
```
...
knitr::include_graphics('analysis/vignettes/figures/sensitivity_plots/tcoverage_image.png')
knitr::include_graphics('analysis/vignettes/figures/error_images/tcoverage_error.png')
```
...
knitr::include_graphics('analysis/vignettes/figures/sensitivity_plots/tloci_image.png')
knitr::include_graphics('analysis/vignettes/figures/error_images/tloci_error.png')
```
...
knitr::include_graphics('analysis/vignettes/figures/sensitivity_plots/talpha_image.png')
knitr::include_graphics('analysis/vignettes/figures/error_images/talpha_error.png')
```
...
knitr::include_graphics('analysis/vignettes/figures/sensitivity_plots/tover_image.png')
knitr::include_graphics('analysis/vignettes/figures/error_images/tover_error.png')
```
...
knitr::include_graphics('analysis/vignettes/figures/sensitivity_plots/tepsilon_image.png')
knitr::include_graphics('analysis/vignettes/figures/error_images/tepsilon_error.png')
```
...
knitr::include_graphics('analysis/vignettes/figures/sensitivity_plots/tseq_image.png')
knitr::include_graphics('analysis/vignettes/figures/error_images/tseq_error.png')
```
...
saveRDS(saved_analysis, file = "analysis/vignettes/saved_analysis.rds")
...
for (i in seq_len(length(update_images))){
  filename = paste0("analysis/vignettes/figures/sensitivity_plots/", 
...
for (i in seq_len(length(update_errors))){
  filename = paste0("analysis/vignettes/figures/error_images/", 
