...
tweight <- cont_sensitivity(coi = 2:20, weighted = c(FALSE, TRUE),
...
tweight_fig <- ggpubr::ggarrange(tweight_image, tweight_error, 
                                 labels = c("", "E"),
                                 heights = c(2, 1),
                                 nrow = 2, 
                                 font.label = list(size = 10)) 
...
knitr::include_graphics('figures/continuous/tweight.png')
```
...
tcoverage <- cont_sensitivity(coi = 2:20, coverage = c(25, 50, 100, 200, 400, 800), 
                         repetitions = 100, plaf = p, coi_method = c("1", "2"))
