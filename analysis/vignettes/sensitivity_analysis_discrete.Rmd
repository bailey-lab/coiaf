...
tcoi <- sensitivity(coi = 2:40, max_coi = 40, repetitions = 1, plaf = p,
                    coi_method = c("1", "2"))
...
tcomparison <- sensitivity(coi = 2:20, plaf = p, 
                           ...
                           distance = "squared", repetitions = 1)
...
tcomparison_error <- error_plot(tmethod, fill = "comparison", 
                                legend_title = "Method", 
...
knitr::include_graphics('figures/tcomparison.png')
```
...
tdistance <- sensitivity(coi = 2:20, plaf = p, comparison = "overall",
                         ...
                         repetitions = 1, coi_method = c("1", "2"))
...
tweight <- sensitivity(coi = 2:20, weighted = c(FALSE, TRUE),
                       distance = "squared", plaf = p, repetitions = 1,
                       coi_method = c("1", "2"))
...
bloci <- lapply(loci, function(new_L){
  ...
  inner_tloci <- sensitivity(coi = 2:20, repetitions = 1, plaf = new_p,
                             coi_method = "1")
