...
# %>% ggpubr::ggexport(filename = "analysis/figures/sensitivity_plots/tcoi_image.png")
# %>% ggpubr::ggexport(filename = "analysis/figures/error_images/tcoi_error.png")
```
...
all values of the COI. The KL divergence, although it too performs well, it 
...
algorithm predicts COIs much higher than the true COI, in some cases even 
